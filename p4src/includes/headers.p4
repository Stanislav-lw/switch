...
#define FABRIC_header_NONE        3w0
#define FABRIC_header_UNICAST     3w1
#define FABRIC_header_MULTICAST   3w2
#define FABRIC_header_MIRROR      3w3
#define FABRIC_header_CONTROL     3w4
#define FABRIC_header_CPU         3w5
...
struct headers_t
{
    ...
    roce_header_t roce_header;
    roce_v2_header_t roce_v2_header;
    fcoe_header_t fcoe_header;
    vlan_tag_t[VLAN_DEPTH] vlan_tag;
    ieee802_1ah_t ieee802_1ah;
    mpls_t[MPLS_DEPTH] mpls; /* all the tags but the last one */
    icmp_t icmp;
    ipv4_t ipv4;
    ipv6_t ipv6;
    sctp_t sctp;
    ...
    gre_t gre;
    nvgre_t nvgre; 
    erspan_header_t3_t erspan_header_t3;
    ipsec_esp_t ipsec_esp;
    ipsec_ah_t ipsec_ah;
    arp_rarp_t arp_rarp;
...
#endif
    int_value_t[MAX_INT_INFO] int_value;
}